...
const CONTENT = {
  en: {
    ...
    pillars: [
      { icon: 'pavti', label: { en: 'Digital Pavti', mr: 'डिजिटल पावती', hi: 'डिजिटल पावती' }, desc: { en: 'Instant receipt for every contribution', mr: 'प्रत्येक वर्गणीसाठी तात्काळ रसीद', hi: 'हर योगदान के लिए तत्काल रसीद' } },
      { icon: 'collection', label: { en: 'Vargani Record', mr: 'वर्गणी रेकॉर्ड', hi: 'वर्गणी रिकॉर्ड' }, desc: { en: 'Real-time collection tracking', mr: 'रीयल-टाइम संकलन तपशील', hi: 'रीयल-टाइम संग्रह ट्रैकिंग' } },
      { icon: 'expense', label: { en: 'Expense Log', mr: 'खर्च लॉग', hi: 'खर्च लॉग' }, desc: { en: 'Every rupee spent recorded', mr: 'प्रत्येक रुपये खर्च नोंदलेले', hi: 'हर रुपया खर्च रिकॉर्डेड' } },
      { icon: 'balance', label: { en: 'Live Balance', mr: 'लाइव्ह शिल्लक', hi: 'लाइव बैलेंस' }, desc: { en: 'Collection minus expense, always', mr: 'संकलन वजा खर्च, नेहमी', hi: 'संग्रह घटा खर्च, हमेशा' } },
    ],
...
const TransparencySection = forwardRef<HTMLElement, TransparencySectionProps>(
  ({ language = 'en', className = '', style }, ref) => {
    ...
    useEffect(() => {
      ...
      const ctx = gsap.context(() => {
        ScrollTrigger.create({
          ...
          onEnter: () => {
            setIsVisible(true);
            const pillars = ['pavti', 'collection', 'expense', 'balance'];
            pillars.forEach((pillar, idx) => {
              setTimeout(() => setPillarStates(prev => ({ ...prev, [pillar]: true })), idx * 200);
            });
          },
          once: true,
        });
    ...
    return (
      <section
        ref={sectionRef}
        id="transparency"
        className={`transparency-section ${className}`}
        style={{
          position: 'relative',
          padding: '8rem 2rem',
          background: `
      ...
      >
        <div className="container" style={{ maxWidth: '1200px', margin: '0 auto' }}>
          ...
          >
            <p
              className="transparency-eyebrow"
              style={{
            ...
            <h2
              ...
              className="transparency-headline"
              style={{
            ...
            <p
              className="transparency-subheadline"
              style={{
                fontFamily: 'var(--font-body)',
          ...
          >
            {content.pillars.map((pillar, idx) => (
              <TransparencyPillar
                ...
                isVisible={isVisible && pillarStates[pillar.icon]}
...
function TransparencyPillar({
  ...
  pillar: { label: { en: string; mr: string; hi: string }; desc: { en: string; mr: string; hi: string }; icon: string };
